...
class IPFSManager:  # Renamed from HospitalIPFSClient
     
    def __init__(self, base_url: str = "http://localhost:5002"):
        self.base_url = base_url
        self.api_url = f"{base_url}/api/v0"
        self.connected = self.test_connection()  # Added connected property
    ...
    def add_json_to_ipfs(self, data: Dict[str, Any]) -> str:
        result = self.add_json_data(data, "Analysis Data")
